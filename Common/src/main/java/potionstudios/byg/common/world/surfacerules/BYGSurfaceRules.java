...
public class BYGSurfaceRules {
    ...
    public static final SurfaceRules.RuleSource BLACK_SAND_SURFACE = SurfaceRules.ifTrue(SurfaceRules.isBiome(BYGBiomes.VOLCANIC_LANDS), SurfaceRules.sequence(SurfaceRules.ifTrue(WATER_CHECK, SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, SurfaceRules.state(BYGBlocks.BLACK_SAND.defaultBlockState()))), SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, SurfaceRules.state(BYGBlocks.BLACK_SAND.defaultBlockState()))));
